...
mod windows_unit_test {
    ...
    fn test_windows() {
        ...
        test_with_admin(app_name, app_path, args, false);
        ...
        if LOCAL_MACHINE
            ...
            .is_ok()
        {
            test_with_admin(app_name, app_path, args, true);
        }
    }

    fn test_with_admin(app_name: &str, app_path: &str, args: &[&str], with_admin: bool) {
